 ...
 * @returns 需要被包装的函数
 */
declare function _onceOfSameParam<Fn extends Func>(fn: Fn, identity?: (fn: Func, args: any[]) => string, memoryCache?: import("../cache/MemoryCache").BaseMemoryCache<any, any>): Fn & {
    origin: Fn;
    clear: (...keys: any[]) => void;
};
